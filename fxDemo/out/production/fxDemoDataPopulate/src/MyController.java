...
public class MyController {
    ...
    public void create_excel(ActionEvent actionEvent) {
        ...
        try {
            ...
            XSSFSheet exSheet = workbook.createSheet("profile details");
            XSSFRow exHeader = exSheet.createRow(0);
            System.out.println("1111");
            ((XSSFRow) exHeader).createCell(0).setCellValue("ORDER_ID");
            ...
            FileOutputStream outputFile = new FileOutputStream("DemoOrder.xlsx");
